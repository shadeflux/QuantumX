-- Quantum X – CZARNE, RESPONSIVE UI + WSZYSTKIE FUNKCJE
...
InfJumpButton.Position = UDim2.new(0.1, 0, 0.28, 0)
...
FlingButton.Position = UDim2.new(0.1, 0, 0.54, 0)
...
AntiFlingButton.Size = UDim2.new(0.8, 0, 0, 50)
AntiFlingButton.Position = UDim2.new(0.1, 0, 0.67, 0)
...
-- Dodaj tu resztę (teleport, spectate, anti afk itd.) w ten sam sposób jako kolejne buttony
...
print("Quantum X – czarne UI bez key systemu załadowane")
